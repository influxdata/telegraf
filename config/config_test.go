...
func TestConfig_LoadDirectory(t *testing.T) {
	c := NewConfig()
	require.NoError(t, c.LoadConfig("./testdata/single_plugin.toml", nil))
...
func TestConfig_LoadSpecialTypes(t *testing.T) {
	c := NewConfig()
	require.NoError(t, c.LoadConfig("./testdata/special_types.toml", nil))
...
func TestConfig_FieldNotDefined(t *testing.T) {
	c := NewConfig()
	err := c.LoadConfig("./testdata/invalid_field.toml", nil)
...
func TestConfig_WrongFieldType(t *testing.T) {
	c := NewConfig()
	err := c.LoadConfig("./testdata/wrong_field_type.toml", nil)
	...
	c = NewConfig()
	err = c.LoadConfig("./testdata/wrong_field_type2.toml", nil)
...
func TestConfig_InlineTables(t *testing.T) {
	// #4098
	c := NewConfig()
	require.NoError(t, c.LoadConfig("./testdata/inline_table.toml", nil))
...
func TestConfig_SliceComment(t *testing.T) {
	...
	c := NewConfig()
	require.NoError(t, c.LoadConfig("./testdata/slice_comment.toml", nil))
...
func TestConfig_BadOrdering(t *testing.T) {
	...
	c := NewConfig()
	err := c.LoadConfig("./testdata/non_slice_slice.toml", nil)
...
func TestConfig_AzureMonitorNamespacePrefix(t *testing.T) {
	...
	c := NewConfig()
	require.NoError(t, c.LoadConfig("./testdata/azure_monitor.toml", nil))
	require.Len(t, c.Outputs, 2)
...
func TestConfig_URLRetries3FailsThenPasses(t *testing.T) {
	...
	c := NewConfig()
	require.NoError(t, c.LoadConfig(ts.URL, nil))
	require.Equal(t, 4, responseCounter)
}
