...
| FlightSQL            | [flightsql](https://github.com/apache/arrow-go/tree/main/arrow/flight/flightsql/driver) |                 | `flightsql://[username[:password]@]host:port?timeout=10s[&token=TOKEN][&param1=value1&...&paramN=valueN]`        | see [driver docs](https://github.com/apache/arrow-go/blob/main/arrow/flight/flightsql/driver/README.md) for more information |
