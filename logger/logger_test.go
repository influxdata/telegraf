...
func TestWriteLogToFile(t *testing.T) {
	...
	SetupLogging(false, false, tmpfile.Name(), 0, internal.Size{Size: int64(0)}, 0)
	log.Printf("I! TEST")
...
func TestDebugWriteLogToFile(t *testing.T) {
	...
	SetupLogging(true, false, tmpfile.Name(), 0, internal.Size{Size: int64(0)}, 0)
	log.Printf("D! TEST")
...
func TestErrorWriteLogToFile(t *testing.T) {
	...
	SetupLogging(false, true, tmpfile.Name(), 0, internal.Size{Size: int64(0)}, 0)
	log.Printf("E! TEST")
...
func TestWriteToFileInRotation(t *testing.T) {
	...
	writer := setupLoggingAndReturnWriter(false, false, filepath.Join(tempDir, "test.log"), 0, internal.Size{Size: int64(30)}, -1)
