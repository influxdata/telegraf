...
func TestAzureSQL_Database_ResourceGovernance_Query(t *testing.T) {
	...
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "dtu_limit"))
	require.True(t, acc.HasField("sqlserver_db_resource_governance", "max_cpu"))
	require.True(t, acc.HasField("sqlserver_db_resource_governance", "cap_cpu"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "instance_cap_cpu"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "max_db_memory"))
	...
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "instance_max_worker_threads"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "primary_group_max_workers"))
	...
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "primary_group_min_io"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "primary_group_max_io"))
	...
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "primary_pool_max_workers"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "pool_max_io"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "checkpoint_rate_mbps"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "checkpoint_rate_io"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_local_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_managed_xstore_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_external_xstore_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_type_local_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_type_managed_xstore_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_type_external_xstore_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_pfs_iops"))
	require.True(t, acc.HasInt32Field("sqlserver_db_resource_governance", "volume_type_pfs_iops"))
	require.True(t, acc.HasTag("sqlserver_db_resource_governance", "replica_updateability"))

	server.Stop()
}

func TestAzureSQL_Database_DBWaitStats_Query(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestAzureSQL_Database_DatabaseIO_Query(t *testing.T) {
	...
	require.True(t, acc.HasField("sqlserver_database_io", "database_id"))
	require.True(t, acc.HasField("sqlserver_database_io", "file_id"))
	...
	require.True(t, acc.HasField("sqlserver_database_io", "current_size_mb"))
	require.True(t, acc.HasField("sqlserver_database_io", "space_used_mb"))
...
func TestAzureSQL_Database_ServerProperties_Query(t *testing.T) {
	...
	require.True(t, acc.HasField("sqlserver_server_properties", "sku"))
	require.True(t, acc.HasTag("sqlserver_server_properties", "engine_edition"))
	require.True(t, acc.HasTag("sqlserver_server_properties", "hardware_type"))
	require.True(t, acc.HasField("sqlserver_server_properties", "total_storage_mb"))
	require.True(t, acc.HasField("sqlserver_server_properties", "available_storage_mb"))
	require.True(t, acc.HasField("sqlserver_server_properties", "uptime"))
...
func TestAzureSQL_Database_OsWaitstats_Query(t *testing.T) {
	...
	server := &SQLServer{
		Servers:      []string{connectionString},
		IncludeQuery: []string{"AzureSQLOsWaitstats"},
		AuthMethod:   "connection_string",
		DatabaseType: "AzureSQLDB",
	}
	...
	require.True(t, acc.HasField("sqlserver_waitstats", "resource_wait_ms"))
...
func TestAzureSQL_Database_MemoryClerks_Query(t *testing.T) {
	...
	require.True(t, acc.HasTag("sqlserver_waitstats", "sql_instance"))
	require.True(t, acc.HasTag("sqlserver_waitstats", "database_name"))
	require.True(t, acc.HasTag("sqlserver_waitstats", "clerk_type"))
	require.True(t, acc.HasInt64Field("sqlserver_waitstats", "size_kb"))
	require.True(t, acc.HasTag("sqlserver_waitstats", "replica_updateability"))
...
func TestAzureSQL_Database_Requests_Query(t *testing.T) {
	...
	require.True(t, acc.HasField("sqlserver_requests", "objectid"))
	require.True(t, acc.HasField("sqlserver_requests", "stmt_object_name"))
	require.True(t, acc.HasField("sqlserver_requests", "stmt_db_name"))
