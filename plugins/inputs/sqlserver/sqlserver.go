...
import (
	...
	_ "github.com/influxdb/telegraf/plugins/inputs/sqlserver/go-mssqldb"
)
...
, type = 'CPU'
-- value
, [SQL process percent] = ProcessUtilization
, [External percent]= 100 - SystemIdle - ProcessUtilization
, [System idle percent]
FROM
(
