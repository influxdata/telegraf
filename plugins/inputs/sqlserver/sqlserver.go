...
## dashboards.
## Version 2 - is compatible from SQL Server 2008 SP4 and later versions and also for SQL Azure DB
query_version = 2
...
SELECT	
	...
	,CAST(SERVERPROPERTY(''EngineEdition'') as smallint) as [engine_edition]'
+ CASE WHEN @MajorVersion <= 10 AND @MinorVersion < 50 
	THEN N'	,''Not Available'' AS [virtual_machine_type_desc] /*Before SQL 2008 R2*/' 
