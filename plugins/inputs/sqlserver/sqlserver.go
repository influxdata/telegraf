...
## This enables a specific set of queries depending on the database type. It replaces azuredb = true/false.
## In the config file, the sql server plugin section can be repeated multiple times each with a set of servers for a specific database_type
