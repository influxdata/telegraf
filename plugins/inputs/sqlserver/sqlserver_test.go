...
func TestSqlServer_QueryStoreCollection(t *testing.T) {
	cases := []map[string]interface{}{
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{},
			"ExcludeQuery":         []string{"AzureSQLDBResourceStats", "AzureSQLDBResourceGovernance", "AzureSQLDBWaitStats", "AzureSQLDBDatabaseIO", "AzureSQLDBServerProperties"},
			"QueryStoreCollection": true,
			"expectedQueries":      []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks", "AzureSQLDBPerformanceCounters", "AzureSQLDBRequests", "AzureSQLDBSchedulers", "AzureSQLDBQueryStoreRuntimeStatistics", "AzureSQLDBQueryStoreWaitStatistics"},
		},
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{},
			"ExcludeQuery":         []string{},
			"QueryStoreCollection": true,
			"expectedQueries":      []string{"AzureSQLDBResourceStats", "AzureSQLDBResourceGovernance", "AzureSQLDBWaitStats", "AzureSQLDBOsWaitstats", "AzureSQLDBDatabaseIO", "AzureSQLDBServerProperties", "AzureSQLDBMemoryClerks", "AzureSQLDBPerformanceCounters", "AzureSQLDBRequests", "AzureSQLDBSchedulers", "AzureSQLDBQueryStoreRuntimeStatistics", "AzureSQLDBQueryStoreWaitStatistics"},
		},
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{},
			"ExcludeQuery":         []string{},
			"QueryStoreCollection": false,
			"expectedQueries":      []string{"AzureSQLDBResourceStats", "AzureSQLDBResourceGovernance", "AzureSQLDBWaitStats", "AzureSQLDBOsWaitstats", "AzureSQLDBDatabaseIO", "AzureSQLDBServerProperties", "AzureSQLDBMemoryClerks", "AzureSQLDBPerformanceCounters", "AzureSQLDBRequests", "AzureSQLDBSchedulers"},
		},
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks"},
			"ExcludeQuery":         []string{"AzureSQLDBResourceStats", "AzureSQLDBResourceGovernance", "AzureSQLDBWaitStats", "AzureSQLDBDatabaseIO", "AzureSQLDBServerProperties"},
			"QueryStoreCollection": true,
			"expectedQueries":      []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks"},
		},
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks"},
		...
		},
		{
			"DatabaseType":         typeAzureSQLDB,
			"IncludeQuery":         []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks"},
			"ExcludeQuery":         []string{"AzureSQLDBResourceGovernance"},
			"QueryStoreCollection": false,
			"expectedQueries":      []string{"AzureSQLDBOsWaitstats", "AzureSQLDBMemoryClerks"},
		},
		{
			...
			"IncludeQuery":         []string{},
			"ExcludeQuery":         []string{"SQLServerPerformanceCounters", "SQLServerWaitStatsCategorized", "SQLServerRequests", "SQLServerVolumeSpace", "SQLServerCpu"},
			"QueryStoreCollection": true,
			"expectedQueries":      []string{"SQLServerDatabaseIO", "SQLServerProperties", "SQLServerMemoryClerks", "SQLServerSchedulers", "SQLServerAvailabilityReplicaStates", "SQLServerDatabaseReplicaStates"},
		},
		{
			"DatabaseType":         typeSQLServer,
			"IncludeQuery":         []string{"SQLServerPerformanceCounters", "SQLServerWaitStatsCategorized"},
			"ExcludeQuery":         []string{},
			"QueryStoreCollection": false,
			"expectedQueries":      []string{"SQLServerPerformanceCounters", "SQLServerWaitStatsCategorized"},
		},
		{
			"DatabaseType":         typeAzureSQLManagedInstance,
			"IncludeQuery":         []string{"AzureSQLMIResourceStats", "AzureSQLMIResourceGovernance"},
			"ExcludeQuery":         []string{},
			"QueryStoreCollection": false,
			"expectedQueries":      []string{"AzureSQLMIResourceStats", "AzureSQLMIResourceGovernance"},
		},
		{
			"DatabaseType":         typeAzureSQLManagedInstance,
			"IncludeQuery":         []string{"AzureSQLMIResourceStats", "AzureSQLMIResourceGovernance"},
	...
	for _, test := range cases {
		s := SQLServer{
			DatabaseType:         test["DatabaseType"].(string),
			IncludeQuery:         test["IncludeQuery"].([]string),
			ExcludeQuery:         test["ExcludeQuery"].([]string),
			QueryStoreCollection: test["QueryStoreCollection"].(bool),
		}
		require.NoError(t, initQueries(&s))
		require.Equal(t, len(s.queries), len(test["expectedQueries"].([]string)))
		for _, query := range test["expectedQueries"].([]string) {
			require.Contains(t, s.queries, query)
		}
	}
}
