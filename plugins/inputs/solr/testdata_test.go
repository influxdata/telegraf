...
var solrAdminMainCoreStatusExpected = map[string]interface{}{
	"num_docs":      int(168943425),
	"max_docs":      int(169562700),
	"deleted_docs":  int(619275),
	"size_in_bytes": int64(247497521642),
}

var solrAdminCore1StatusExpected = map[string]interface{}{
	"num_docs":      int(7517488),
	"max_docs":      int(7620303),
	"deleted_docs":  int(102815),
...
var solrCoreExpected = map[string]interface{}{
	...
	"num_docs":     int(168962621),
	"max_docs":     int(169647870),
	"deleted_docs": int(685249),
}
...
var solrQueryHandlerExpected = map[string]interface{}{
	...
	"errors":                     int(0),
	"handler_start":              int(1482259270810),
...
var solrCacheExpected = map[string]interface{}{
	...
	"cumulative_hits":      int(55),
	"cumulative_inserts":   int(14),
	"cumulative_lookups":   int(69),
	"evictions":            int(0),
	"hitratio":             float64(0),
	"hits":                 int(0),
	"inserts":              int(0),
