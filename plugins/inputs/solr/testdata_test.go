    ...
    "QUERYHANDLER",
    {
      ...
      "org.apache.solr.handler.ReplicationHandler": {
        "stats": {
          ...
          "mainUrl": "http://solr-s1:8983/solr/main",
          "isSubordinate": "true",
          "isMain": "false",
        ...
        "description": "ReplicationHandler provides replication of index and configuration files from Main to Subordinates",
        "version": "4.3.1",
    ...
    "QUERYHANDLER",
    {
      ...
      "org.apache.solr.handler.ReplicationHandler": {
        "stats": {
          ...
          "mainUrl": "http://solr-s1:8983/solr/core1",
          "isSubordinate": "true",
          "isMain": "false",
