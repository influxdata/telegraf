...
func (u *Upsd) gatherUps(acc telegraf.Accumulator, name string, variables []nut.Variable) {
	...
	fields := map[string]interface{}{
        ...
        "ups_type: online":        metrics["ups.type: online"],
        "ups_vendorid":            metrics["ups.vendorid"],
        "ups_test_interval":       metrics["ups.test.interval"],
	...
	floatValues := map[string]string{
		...
		"output_frequency.nominal": "output.frequency.nominal",
		"output_voltage.nominal":   "output.voltage.nominal",
		"ups_power":                "ups.power",
