			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						"driver_version":                     5925,
						"fan_speed":                          13,
						"memory_total":                       17163091968,
						"memory_used":                        17776640,
						"memory_free":                        17145315328,
						"temperature_sensor_edge":            39.0,
						"temperature_sensor_sensor_junction": 40.0,
			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						"driver_version":                     5917,
						"fan_speed":                          0,
						"memory_total":                       34342961152,
						"memory_used":                        10850304,
						"memory_free":                        34332110848,
						"temperature_sensor_edge":            36.0,
						"temperature_sensor_sensor_junction": 38.0,
