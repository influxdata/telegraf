...
type MockClient struct {
	...
	ContainerListF    func(options type_container.ListOptions) ([]types.Container, error)
	ContainerStatsF   func(containerID string) (type_container.StatsResponseReader, error)
...
func (c *MockClient) ContainerList(_ context.Context, options type_container.ListOptions) ([]types.Container, error) {
	return c.ContainerListF(options)
}

func (c *MockClient) ContainerStats(_ context.Context, containerID string, _ bool) (type_container.StatsResponseReader, error) {
...
var baseClient = MockClient{
	...
	ContainerListF: func(type_container.ListOptions) ([]types.Container, error) {
		return containerList, nil
	},
	ContainerStatsF: func(s string) (type_container.StatsResponseReader, error) {
	...
	d := Docker{
		...
		newClient: func(string, *tls.Config) (Client, error) {
			return &MockClient{
				...
				ContainerStatsF: func(string) (type_container.StatsResponseReader, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			newClientFunc := func(string, *tls.Config) (Client, error) {
				client := baseClient
				client.ContainerListF = func(type_container.ListOptions) ([]types.Container, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			newClientFunc := func(string, *tls.Config) (Client, error) {
				...
				client.ContainerStatsF = func(s string) (type_container.StatsResponseReader, error) {
					return containerStats(s), nil
				}
...
func TestContainerStateFilter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			newClientFunc := func(string, *tls.Config) (Client, error) {
				client := baseClient
				client.ContainerListF = func(options type_container.ListOptions) ([]types.Container, error) {
					for k, v := range tt.expected {
	...
	tests := []struct {
	...
	}{
		{
			...
			clientFunc: func(string, *tls.Config) (Client, error) {
				...
				client.ContainerStatsF = func(string) (type_container.StatsResponseReader, error) {
					return type_container.StatsResponseReader{
