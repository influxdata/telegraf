	...
	expected := []telegraf.Metric{
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"temperature":  9.25,
				"rain":         0.0,
				"sunrise":      1544167818000000000,
				"sunset":       1544198047000000000,
				"wind_degrees": 290.0,
				"wind_speed":   8.7,
				"visibility":   10000,
			},
	...
	expected := []telegraf.Metric{
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"wind_speed":   5.0,
				"rain":         0.0,
				"sunrise":      1556416455000000000,
				"sunset":       1556470779000000000,
				"visibility":   10000,
			},
		...
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"wind_speed":   1.0,
				"rain":         0.0,
				"sunrise":      1556419155000000000,
				"sunset":       1556471486000000000,
				"visibility":   10000,
			},
			time.Unix(1556444155, 0),
		),
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"wind_speed":   6.2,
				"rain":         0.072,
				"sunrise":      1556426319000000000,
				"sunset":       1556479032000000000,
				"visibility":   10000,
			},
			time.Unix(1556444155, 0),
		),
