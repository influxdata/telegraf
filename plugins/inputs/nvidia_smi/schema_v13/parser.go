...
func Parse(acc telegraf.Accumulator, buf []byte) error {
	...
	for i := range s.Gpu {
		...
		common.SetIfUsed("int", fields, "temperature_max_tlimit_threshold", gpu.Temperature.GpuTempMaxTlimitThreshold)
		common.SetIfUsed("int", fields, "temperature_slow_tlimit_threshold", gpu.Temperature.GpuTempSlowTlimitThreshold)
		common.SetIfUsed("int", fields, "temperature_max_gpu_tlimit_threshold", gpu.Temperature.GpuTempMaxGpuTlimitThreshold)
		common.SetIfUsed("int", fields, "temperature_max_mem_tlimit_threshold", gpu.Temperature.GpuTempMaxMemTlimitThreshold)
		...
		common.SetIfUsed("int", fields, "clocks_event_reasons_counters_hw_therm_slowdown", counters.ClocksEventReasonsCountersHwThermSlowdown)
		common.SetIfUsed("int", fields, "clocks_event_reasons_counters_hw_power_brake", counters.ClocksEventReasonsCountersHwPowerBrake)
		common.SetIfUsed("int", fields, "clocks_event_reasons_counters_sync_boost", counters.ClocksEventReasonsCountersSyncBoost)
