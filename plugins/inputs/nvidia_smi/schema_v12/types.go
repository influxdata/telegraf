...
type smi struct {
	AttachedGpus  int64  `xml:"attached_gpus"`
	...
	Gpu           []struct {
		...
		AccountingModeBufferSize int64    `xml:"accounting_mode_buffer_size"`
		...
		InforomVersion struct {
			...
			OemObject  float64 `xml:"oem_object"`
		...
		Pci           struct {
			...
			PciBus         int64  `xml:"pci_bus"`
			PciBusID       string `xml:"pci_bus_id"`
			PciDevice      int64  `xml:"pci_device"`
			PciDeviceID    string `xml:"pci_device_id"`
			PciDomain      int64  `xml:"pci_domain"`
			PciGpuLinkInfo struct {
				...
				PcieGen struct {
					...
					DeviceCurrentLinkGen int64  `xml:"device_current_link_gen"`
					MaxDeviceLinkGen     int64  `xml:"max_device_link_gen"`
					MaxHostLinkGen       string `xml:"max_host_link_gen"`
					MaxLinkGen           int64  `xml:"max_link_gen"`
				} `xml:"pcie_gen"`
			} `xml:"pci_gpu_link_info"`
			PciSubSystemID        string `xml:"pci_sub_system_id"`
			ReplayCounter         bool   `xml:"replay_counter"`
			ReplayRolloverCounter bool   `xml:"replay_rollover_counter"`
