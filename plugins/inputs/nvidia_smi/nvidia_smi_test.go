...
func TestGatherValidXML(t *testing.T) {
	tests := []struct {
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"clocks_event_reason_applications_clocks_setting": 0,
						"clocks_event_reason_display_clocks_setting":      0,
						"clocks_event_reason_gpu_idle":                    1,
						"clocks_event_reason_hw_power_brake_slowdown":     0,
						"clocks_event_reason_hw_slowdown":                 0,
						"clocks_event_reason_hw_thermal_slowdown":         0,
						"clocks_event_reason_sw_power_cap":                0,
						"clocks_event_reason_sw_thermal_slowdown":         0,
						"clocks_event_reason_sync_boost":                  0,
						"cuda_version":                                    "10.1",
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"power_draw":                                      4.61,
						"power_limit":                                     75.0,
						"power_limit_default":                             75.0,
						"power_limit_max":                                 75.0,
						"power_limit_min":                                 75.0,
						"serial":                                          "0322218049033",
						"temperature_gpu":                                 34,
						"temperature_gpu_target":                          83,
						"temperature_gpu_target_max":                      98,
						"temperature_gpu_target_min":                      65,
						"temperature_max_threshold":                       104,
						"temperature_slow_threshold":                      101,
						"utilization_gpu":                                 0,
						"utilization_memory":                              0,
						"utilization_encoder":                             0,
						"utilization_decoder":                             0,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"clocks_event_reason_applications_clocks_setting": 0,
						"clocks_event_reason_display_clocks_setting":      0,
						"clocks_event_reason_gpu_idle":                    0,
						"clocks_event_reason_hw_power_brake_slowdown":     0,
						"clocks_event_reason_hw_slowdown":                 0,
						"clocks_event_reason_hw_thermal_slowdown":         0,
						"clocks_event_reason_sw_power_cap":                0,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"fan_speed":                                       0,
						"power_draw":                                      11.63,
						"power_draw_average":                              11.60,
						"power_limit":                                     170.0,
						"power_limit_default":                             170.0,
						"power_limit_max":                                 190.0,
						"power_limit_min":                                 100.0,
						"power_limit_requested":                           170.0,
						"memory_free":                                     11806,
						"memory_total":                                    12288,
						"memory_used":                                     116,
						"memory_reserved":                                 368,
						...
						"temperature_gpu":                                 42,
						"temperature_gpu_target":                          83,
						"temperature_gpu_target_max":                      90,
						"temperature_gpu_target_min":                      65,
						"temperature_max_gpu_threshold":                   93,
						"temperature_max_threshold":                       98,
						"temperature_slow_threshold":                      95,
						"utilization_gpu":                                 0,
						"utilization_jpeg":                                0,
						"utilization_memory":                              0,
						"utilization_encoder":                             0,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"power_draw":                                      22.78,
						"power_limit":                                     336.0,
						"power_limit_default":                             320.0,
						"power_limit_max":                                 336.0,
						"power_limit_min":                                 100.0,
						"power_limit_requested":                           336.0,
						"memory_free":                                     8938,
						"memory_total":                                    10240,
						"memory_used":                                     1128,
						"memory_reserved":                                 173,
						...
						"pcie_tx_util":                                    1000,
						"temperature_gpu":                                 31,
						"temperature_gpu_target":                          91,
						"temperature_gpu_target_max":                      91,
						"temperature_gpu_target_min":                      65,
						"temperature_max_gpu_threshold":                   93,
						"temperature_max_threshold":                       98,
						"temperature_slow_threshold":                      95,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"clocks_event_reason_sw_thermal_slowdown":         0,
						"clocks_event_reason_sync_boost":                  0,
						"clocks_event_reasons_counters_hw_power_brake":    0,
						"clocks_event_reasons_counters_hw_therm_slowdown": 0,
						"clocks_event_reasons_counters_sw_power_cap":      0,
						"clocks_event_reasons_counters_sw_therm_slowdown": 0,
						"clocks_event_reasons_counters_sync_boost":        0,
						"cuda_version":                                    "13.2",
						"display_active":                                  "Disabled",
						...
						"pcie_link_gen_current":                           4,
						"pcie_link_width_current":                         16,
						"pcie_rx_util":                                    14742333,
						"pcie_tx_util":                                    1066699,
						"power_draw":                                      142.33,
						"power_draw_average":                              139.62,
						"power_limit":                                     320.0,
						"power_limit_default":                             320.0,
						"power_limit_max":                                 336.0,
						"power_limit_min":                                 100.0,
						"power_limit_requested":                           320.0,
						"serial":                                          "REDACTED",
						"temperature_gpu":                                 27,
						"temperature_gpu_target":                          83,
						"temperature_gpu_target_max":                      91,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"power_draw":                                      27.23,
						"power_limit":                                     200.0,
						"power_limit_default":                             350.0,
						"power_limit_max":                                 375.0,
						"power_limit_min":                                 100.0,
						"memory_free":                                     24258,
						"memory_total":                                    24576,
						"memory_used":                                     1,
			...
			expected: []telegraf.Metric{
				metric.New(
					...
					map[string]interface{}{
						...
						"power_draw":                                      67.03,
						"power_limit":                                     500.0,
						"power_limit_default":                             500.0,
						"power_limit_max":                                 500.0,
						"power_limit_min":                                 100.0,
						"power_limit_requested":                           500.0,
						"memory_free":                                     80999,
						"memory_total":                                    81920,
						"memory_used":                                     50,
						"memory_reserved":                                 869,
						...
						"temperature_gpu":                                 27,
						"temperature_max_gpu_threshold":                   85,
						"temperature_max_mem_threshold":                   95,
						"temperature_max_threshold":                       92,
						"temperature_memory":                              44,
						"temperature_slow_threshold":                      89,
		...
		{
			name:     "RTX 4000 SFF Ada schema v13",
			filename: "rtx-4000-sff-ada-v13.xml",
			expected: []telegraf.Metric{
				metric.New(
					"nvidia_smi",
					map[string]string{
					...
					map[string]interface{}{
						...
						"clocks_event_reasons_counters_hw_power_brake":    0,
						"clocks_event_reasons_counters_hw_therm_slowdown": 0,
						// Exceeds the 32 bit range, see the parsing in common.SetIfUsed
						"clocks_event_reasons_counters_sw_power_cap":      int64(4251825415),
						"clocks_event_reasons_counters_sw_therm_slowdown": 0,
						"clocks_event_reasons_counters_sync_boost":        0,
						"cuda_version":                         "13.2",
						...
						"pcie_tx_util":                         830,
						"power_draw":                           8.44,
						"power_draw_average":                   8.81,
						"power_limit":                          70.0,
						"power_limit_default":                  70.0,
						"power_limit_max":                      70.0,
						"power_limit_min":                      30.0,
						"power_limit_requested":                70.0,
						"remapped_rows_correctable":            0,
						"remapped_rows_failure":                "No",
						"remapped_rows_pending":                "No",
						"remapped_rows_uncorrectable":          0,
						"serial":                               "REDACTED",
						"temperature_gpu":                      38,
						"temperature_gpu_target":               88,
						"temperature_gpu_target_max":           93,
						"temperature_gpu_target_min":           65,
						"temperature_gpu_tlimit":               49,
						"temperature_max_gpu_tlimit_threshold": 0,
						"temperature_max_tlimit_threshold":     -7,
						"temperature_slow_tlimit_threshold":    -2,
						"utilization_decoder":                  0,
						"utilization_encoder":                  0,
						"utilization_gpu":                      0,
						"utilization_jpeg":                     0,
