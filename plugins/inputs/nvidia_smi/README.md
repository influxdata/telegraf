...
- measurement: `nvidia_smi`
  ...
  - fields
    ...
    - `ecc_errors_volatile_dram_correctable` (integer)
    - `ecc_errors_volatile_dram_uncorrectable` (integer)
    - `ecc_errors_volatile_sram_correctable` (integer)
    - `ecc_errors_volatile_sram_uncorrectable` (integer)
    - `ecc_errors_volatile_sram_uncorrectable_parity` (integer)
    - `ecc_errors_volatile_sram_uncorrectable_secded` (integer)
    - `ecc_errors_aggregate_dram_correctable` (integer)
    - `ecc_errors_aggregate_dram_uncorrectable` (integer)
    - `ecc_errors_aggregate_sram_correctable` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_parity` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_secded` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_l2` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_microcontroller` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_other` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_pcie` (integer)
    - `ecc_errors_aggregate_sram_uncorrectable_sm` (integer)
    - `ecc_errors_aggregate_sram_threshold_exceeded` (string)
    - `ecc_errors_channel_repair_pending` (string)
    - `ecc_errors_tpc_repair_pending` (string)
    - `ecc_errors_unrepairable_memory` (string)
...
- measurement: `nvidia_smi_process` (schema v12+, one per compute process)
  - tags
