						...
						Items: []corev1.Node{
							{
								Status: corev1.NodeStatus{
									...
									Conditions: []corev1.NodeCondition{
										...
										{Type: "DiskPressure", Status: "False", LastTransitionTime: metav1.Time{Time: created}},
										{Type: "MemoryPressure", Status: "False", LastTransitionTime: metav1.Time{Time: now}},
										{Type: "NetworkUnavailable", Status: "False", LastTransitionTime: metav1.Time{Time: created}},
										{Type: "PIDPressure", Status: "False", LastTransitionTime: metav1.Time{Time: now}},
									},
								},
			...
			output: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						...
						"condition_ready":               int64(1),
						"condition_disk_pressure":       int64(0),
						"condition_memory_pressure":     int64(0),
						"condition_network_unavailable": int64(0),
						"condition_pid_pressure":        int64(0),
					},
					time.Unix(0, 0),
				),
			},
