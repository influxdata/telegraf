...
import (
    ...
    "github.com/ios-xr/telegraf-plugin/plugins/inputs/cisco_telemetry_mdt/ems"
	dialout "github.com/ios-xr/telegraf-plugin/plugins/inputs/cisco_telemetry_mdt/mdt_dialout"
    "github.com/ios-xr/telegraf-plugin/plugins/inputs/cisco_telemetry_mdt/telemetry"
...
func (c *CiscoTelemetryMDT) Start(acc telegraf.Accumulator) error {
	...
	case "grpc-dialin":
		...
		client, err := grpc.Dial(c.ServiceAddress, opt)
		if err != nil {
...
func init() {
	inputs.Add("cisco_xr_telemetry", func() telegraf.Input {
