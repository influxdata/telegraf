...
- diskio
  ...
  - fields:
    ...
    - read_time_avg (float, gauge)
    - write_time_avg (float, gauge)
...
#### `read_time_avg` & `write_time_avg`:

The average time an I/O operation took to complete. 
...
```
diskio,name=sda1 merged_reads=0i,read_time_avg=0,reads=2353i,writes=10i,write_bytes=2117632i,write_time=49i,io_time=1271i,weighted_io_time=1350i,write_time_avg=0,read_bytes=31350272i,read_time=1303i,iops_in_progress=0i,merged_writes=0i 1578326400000000000
diskio,name=centos/var_log reads=1063077i,writes=591025i,read_bytes=139325491712i,write_bytes=144233131520i,read_time=650221i,read_time_avg=0.6035550832748413,write_time_avg=18.958877563476562,write_time=24368817i,io_time=852490i,weighted_io_time=25037394i,iops_in_progress=1i,merged_reads=0i,merged_writes=0i 1578326400000000000
diskio,name=sda write_time=49i,io_time=1317i,weighted_io_time=1404i,reads=2495i,read_time=1357i,write_bytes=2117632i,iops_in_progress=0i,merged_reads=0i,merged_writes=0i,read_time_avg=0,write_time_avg=0,writes=10i,read_bytes=38956544i 1578326400000000000
