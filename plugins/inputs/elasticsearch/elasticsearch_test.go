...
func TestGatherClusterStatsMaster(t *testing.T) {
	...
	acc.AssertContainsTaggedFields(t, "elasticsearch_clusterstats", clusterstatsExpected, map[string]string{"name": "es-testcluster"})
	acc.AssertContainsTaggedFields(t, "elasticsearch_clusterstats_nodes", clusterstatsNodesExpected, map[string]string{"name": "es-testcluster"})
	acc.AssertContainsTaggedFields(t, "elasticsearch_clusterstats_indices", clusterstatsIndicesExpected, map[string]string{"name": "es-testcluster"})
}
