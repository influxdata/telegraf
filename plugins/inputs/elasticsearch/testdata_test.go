...
var nodestatsFsExpected = map[string]interface{}{
	...
	"data_0_mount":              "/usr/share/elasticsearch/data",
	"data_0_path":               "/usr/share/elasticsearch/data/elasticsearch/nodes/0",
	"data_0_type":               "ext4",
