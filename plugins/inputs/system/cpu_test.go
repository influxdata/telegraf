...
func TestCPUStats(t *testing.T) {
	...
	assertContainsTaggedFloat(t, &acc, "cpu", "time_active", 19.0611, 0.0005, cputags)
	...
	assertContainsTaggedFloat(t, &acc, "cpu", "time_active", 41.0912, 0.0005, cputags)
	...
	assertContainsTaggedFloat(t, &acc, "cpu", "usage_active", 22.0301, 0.0005, cputags)
