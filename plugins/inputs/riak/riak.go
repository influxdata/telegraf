...
type riakStats struct {
	...
	ReadRepairsFallbackOutofdateCount interface{} `json:"read_repairs_fallback_outofdate_count"`
	ReadRepairsFallbackOutofdateOne   interface{} `json:"read_repairs_fallback_outofdate_one"`
