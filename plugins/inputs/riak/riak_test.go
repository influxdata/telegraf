...
func TestRiak(t *testing.T) {
	...
	expectFields := map[string]interface{}{
		...
		"coord_local_soft_loaded_total":  int64(0),
		"coord_local_unloaded_total":     int64(65),
		"coord_redir_least_loaded_total": int64(0),
		"coord_redir_loaded_local_total": int64(0),
		"coord_redir_unloaded_total":     int64(70),
...
var response = `
{
  ...
  "coord_local_soft_loaded_total": 0,
  "coord_local_unloaded_total": 65,
  "coord_redir_least_loaded_total": 0,
  "coord_redir_loaded_local_total": 0,
  "coord_redir_unloaded_total": 70,
