...
func TestRiak(t *testing.T) {
	...
	expectFields := map[string]interface{}{
		...
		"dropped_vnode_requests_totals":          int64(0),
		...
		"nodename":                               string("riak@127.0.0.1"),
		...
		"read_repairs_fallback_outofdate_count":  float64(36),
		"read_repairs_fallback_outofdate_one":    float64(0),
		...
		"riak_kv_vnodeq_mean":                    float64(0.0),
		...
		"riak_pipe_vnodeq_mean":                  float64(0.0),
		...
		"ring_members":                           []string{"riak@127.0.0.1"},
		"ring_num_partitions":                    int64(64),
		"ring_ownership":                         string("[{'riak@127.0.0.1',64}]"),
		...
		"storage_backend":                        string("riak_kv_multi_backend"),
		"sys_driver_version":                     string("3.3"),
		"sys_global_heaps_size":                  string("deprecated"),
		"sys_heap_type":                          string("private"),
		...
		"sys_smp_support":                        bool(true),
		"sys_system_architecture":                string("x86_64-unknown-linux-gnu"),
		"sys_system_version":                     string("Erlang/OTP 22 [erts-10.7] [source] [64-bit] [smp:24:24] [ds:24:24:10] [async-threads:128]"),
		"sys_thread_pool_size":                   int64(128),
		"sys_threads_enabled":                    bool(true),
