...
```text
vault.raft.replication.appendEntries.logs,peer_id=clustnode-02 count=130i,max=1,mean=0.015384615384615385,min=0,rate=0.2,stddev=0.12355304447984486,sum=2 1638287340000000000
vault.core.unsealed,cluster=vault-cluster-23b671c7 value=1 1638287340000000000
vault.wal.write_controller.idle_secs value=679114.3 1638287340000000000
