...
type VSphere struct {
	...
	DatacenterPropertieInclude   []string        `toml:"datacenter_property_include"`
	...
	ClusterPropertieInclude      []string        `toml:"cluster_property_include"`
	...
	ResourcePoolPropertieInclude []string        `toml:"resource_pool_property_include"`
	...
	HostPropertieInclude         []string        `toml:"host_property_include"`
	...
	VMPropertieInclude           []string        `toml:"vm_property_include"`
	...
	DatastorePropertieInclude    []string        `toml:"datastore_property_include"`
	...
	VSANPropertieInclude         []string        `toml:"vsan_property_include"`
