...
func TestHoldingRegisters(t *testing.T) {
	var holdingRegisterTests = []struct {
		...
		{
			name:      "register0_ab_float32_noScale_noShift",
			address:   []uint16{0},
			quantity:  1,
			byteOrder: "AB",
			dataType:  "FLOAT32",
		...
		{
			name:      "register0_ab_float_noscale_noShift",
			address:   []uint16{0},
			quantity:  1,
			byteOrder: "AB",
			dataType:  "FIXED",
		...
		{
			name:      "register1_ba_ufloat_noScale_noShift",
			address:   []uint16{1},
			quantity:  1,
			byteOrder: "BA",
			dataType:  "UFIXED",
		...
		{
			name:      "register10_ab_uint16_noScale_noShift",
			address:   []uint16{10},
			quantity:  1,
			byteOrder: "AB",
			dataType:  "UINT16",
		...
		{
			name:      "register30_ab_int16_noScale_noShift",
			address:   []uint16{30},
			quantity:  1,
			byteOrder: "AB",
			dataType:  "INT16",
		...
		{
			name:      "register50_register51_abcd_int32_noScale_noShift",
		...
		{
			name:      "register90_register91_abcd_uint32_noScale_noShift",
		...
		{
			name:      "register130_register131_abcd_float32_ieee_noScale_noShift",
		...
		{
			name:      "register140_to_register143_abcdefgh_int64_noScale_noShift",
		...
		{
			name:      "register180_to_register183_abcdefgh_uint64_noScale_noShift",
		...
		{
			name:      "register214_to_register217_abcdefgh_float64_ieee_noScale_noShift",
