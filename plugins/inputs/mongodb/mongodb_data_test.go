...
func TestStateTag(t *testing.T) {
	...
	fields := map[string]interface{}{
		...
		"repl_commands_cnt":         int64(0),
		"repl_commands_per_sec":     int64(0),
		"repl_deletes_cnt":          int64(0),
		"repl_deletes_per_sec":      int64(0),
		"repl_getmores_cnt":         int64(0),
		"repl_getmores_per_sec":     int64(0),
		"repl_inserts_cnt":          int64(0),
		"repl_inserts_per_sec":      int64(0),
		"repl_queries_cnt":          int64(0),
		"repl_queries_per_sec":      int64(0),
		"repl_updates_cnt":          int64(0),
		...
		"ttl_deletes_cnt":           int64(0),
		"ttl_deletes_per_sec":       int64(0),
		"ttl_passes_cnt":            int64(0),
		...
		"cursor_timed_out_cnt":      int64(0),
		"cursor_no_timeout":         int64(0),
		"cursor_no_timeout_cnt":     int64(0),
		"cursor_pinned":             int64(0),
		"cursor_pinned_cnt":         int64(0),
		"cursor_total":              int64(0),
		"cursor_total_cnt":          int64(0),
