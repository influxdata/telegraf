...
var DefaultStats = map[string]string{
	"inserts_cnt":               "InsertCnt",
	"inserts_per_sec":           "Insert",
	"queries_cnt":               "QueryCnt",
	"queries_per_sec":           "Query",
	"updates_cnt":               "UpdateCnt",
	"updates_per_sec":           "Update",
	"deletes_cnt":               "DeleteCnt",
	"deletes_per_sec":           "Delete",
	"getmores_cnt":              "GetMoreCnt",
	"getmores_per_sec":          "GetMore",
	"commands_cnt":              "CommandCnt",
	"commands_per_sec":          "Command",
	"flushes_cnt":               "FlushesCnt",
	...
	"net_in_bytes_cnt":          "NetInCnt",
	"net_in_bytes":              "NetIn",
	"net_out_bytes_cnt":         "NetOutCnt",
	"net_out_bytes":             "NetOut",
	"open_connections":          "NumConnections",
	"ttl_deletes_cnt":           "DeletedDocumentsCnt",
	"ttl_deletes_per_sec":       "DeletedDocuments",
	"ttl_passes_cnt":            "PassesCnt",
	"ttl_passes_per_sec":        "Passes",
	"cursor_timed_out":          "TimedOutC",
	"cursor_timed_out_cnt":      "TimedOutCCnt",
	"cursor_no_timeout":         "NoTimeoutC",
	"cursor_no_timeout_cnt":     "NoTimeoutCCnt",
	"cursor_pinned":             "PinnedC",
	"cursor_pinned_cnt":         "PinnedCCnt",
	"cursor_total":              "TotalC",
	"cursor_total_cnt":          "TotalCCnt",
...
var DefaultReplStats = map[string]string{
	"repl_inserts_cnt":      "InsertRCnt",
	"repl_inserts_per_sec":  "InsertR",
	"repl_queries_cnt":      "QueryRCnt",
	"repl_queries_per_sec":  "QueryR",
	"repl_updates_cnt":      "UpdateRCnt",
	"repl_updates_per_sec":  "UpdateR",
	"repl_deletes_cnt":      "DeleteRCnt",
	"repl_deletes_per_sec":  "DeleteR",
	"repl_getmores_cnt":     "GetMoreRCnt",
	"repl_getmores_per_sec": "GetMoreR",
	"repl_commands_cnt":     "CommandRCnt",
