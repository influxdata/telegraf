...
func Test_metastats(t *testing.T) {
	...
	t.Run("metastats accumulator", func(t *testing.T) {
...
func Test_memstats(t *testing.T) {
	...
	t.Run("memstats accumulator", func(t *testing.T) {
...
func Test_cpustats(t *testing.T) {
	...
	t.Run("cpustats accumulator", func(t *testing.T) {
...
func Test_netstats(t *testing.T) {
	...
	t.Run("netstats accumulator", func(t *testing.T) {
...
func Test_blkstats(t *testing.T) {
	...
	t.Run("blkstats accumulator", func(t *testing.T) {
