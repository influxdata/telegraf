# Linux Memory Input Plugin

The linux_mem plugin collects system memory metrics.
...
```toml @sample.conf
# Read metrics about linux memory usage
[[inputs.linux_mem]]
  # no configuration
```
