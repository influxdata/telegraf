...
func TestHTTPJboss(t *testing.T) {
	...
	fields_jvm := map[string]interface{}{
		...
		"CMS_Old_Gen_committed":        float64(4.294967296e+09),
		"CMS_Old_Gen_init":             float64(4.294967296e+09),
		"CMS_Old_Gen_max":              float64(4.294967296e+09),
		"CMS_Old_Gen_used":             float64(3.054301888e+09),
		"CMS_Perm_Gen_committed":       float64(5.36870912e+08),
		"CMS_Perm_Gen_init":            float64(5.36870912e+08),
		"CMS_Perm_Gen_max":             float64(5.36870912e+08),
		"CMS_Perm_Gen_used":            float64(3.55346576e+08),
		"Code_Cache_committed":         float64(3.5979264e+07),
		"Code_Cache_init":              float64(2.555904e+06),
		"Code_Cache_max":               float64(5.0331648e+07),
		"Code_Cache_used":              float64(3.5578176e+07),
		"ConcurrentMarkSweep_count":    float64(1),
		"ConcurrentMarkSweep_time":     float64(703),
		"ParNew_count":                 float64(18),
		"ParNew_time":                  float64(3259),
		"Par_Eden_Space_committed":     float64(4.294836224e+09),
		"Par_Eden_Space_init":          float64(4.294836224e+09),
		"Par_Eden_Space_max":           float64(4.294836224e+09),
		"Par_Eden_Space_used":          float64(2.629990272e+09),
		"Par_Survivor_Space_committed": float64(65536),
		"Par_Survivor_Space_init":      float64(65536),
		"Par_Survivor_Space_max":       float64(65536),
		"Par_Survivor_Space_used":      float64(0),
		"buffer_direct_count":          float64(1927),
		"buffer_direct_used":           float64(7.3406778e+07),
		"buffer_mapped_count":          float64(20),
		"buffer_mapped_used":           float64(88102),
