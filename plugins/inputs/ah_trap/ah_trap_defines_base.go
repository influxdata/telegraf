//go:build AP3000 || AP5000
// +build AP3000 AP5000

package ah_trap

// AhConnectionChangeTrap for AP3000/AP5000 (without MLO support)
...
// AhTrapMsg for AP3000/AP5000 (smaller union size without MLO)
type AhTrapMsg struct {
	TrapType uint32
	Union    [816]byte // Original size without MLO support
	Level    int32
	MsgID    int32
	Desc     [256]byte
}
