	...
	case AH_THRESHOLD_TRAP_TYPE:
	 ...
	 case AH_CONNECTION_CHANGE_TRAP_TYPE:
                ...
                acc.AddFields("TrapEvent", map[string]interface{}{
                        ...
                        "ssid_connectionChangeTrap":              ahconnectionchange.Ssid,
                        "hostName_connectionChangeTrap":          ahconnectionchange.HostName,
                        "userName_connectionChangeTrap":          ahconnectionchange.UserName,
			...
			"assocTime_connectionChangeTrap":         ahconnectionchange.AssociationTime,
