...
func newTestHTTPSListener() *HTTPSListener {
...
func createURL(listener *HTTPSListener, path string, rawquery string) string {
	u := url.URL{
		Scheme:   "https",
...
func TestRequireClientAuth(t *testing.T) {
	...
	// use the default http client without any client certificate config
	_, err := http.Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(testMsg)))
	require.Error(t, err)
}

func TestDisabledClientAuth(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	// use the default http client without any client certificate config
	_, err := noClientAuthClient.Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(testMsg)))
	require.NoError(t, err)

}

func TestWriteHTTPS(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	resp, err := getClient().Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(testMsg)))
	require.NoError(t, err)
	resp.Body.Close()
	...
	resp, err = getClient().Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(hugeMetric)))
	require.NoError(t, err)
	resp.Body.Close()
...
// https listener should add a newline at the end of the buffer if it's not there
func TestWriteHTTPSNoNewline(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	// post single message to listener
	resp, err := getClient().Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(testMsgNoNewline)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 204, resp.StatusCode)
...
func TestWriteHTTPSMaxLineSizeIncrease(t *testing.T) {
	listener := newTestHTTPSListener()
...
func TestWriteHTTPSVerySmallMaxBody(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	resp, err := getClient().Post(createURL(listener, "/write", ""), "", bytes.NewBuffer([]byte(hugeMetric)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 413, resp.StatusCode)
}

func TestWriteHTTPSVerySmallMaxLineSize(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	resp, err := getClient().Post(createURL(listener, "/write", ""), "", bytes.NewBuffer([]byte(testMsgs)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 204, resp.StatusCode)
...
func TestWriteHTTPSLargeLinesSkipped(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	resp, err := getClient().Post(createURL(listener, "/write", ""), "", bytes.NewBuffer([]byte(hugeMetric+testMsgs)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 400, resp.StatusCode)
...
func TestWriteHTTPSGzippedData(t *testing.T) {
	listener := newTestHTTPSListener()
...
func TestWriteHTTPSHighTraffic(t *testing.T) {
	listener := newTestHTTPSListener()
...
func TestReceive404ForInvalidEndpoint(t *testing.T) {
	...
	// post single message to listener
	resp, err := getClient().Post(createURL(listener, "/foobar", ""), "", bytes.NewBuffer([]byte(testMsg)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 404, resp.StatusCode)
}

func TestWriteHTTPSInvalid(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	// post single message to listener
	resp, err := getClient().Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(badMsg)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 400, resp.StatusCode)
}

func TestWriteHTTPSEmpty(t *testing.T) {
	listener := newTestHTTPSListener()
	...
	// post single message to listener
	resp, err := getClient().Post(createURL(listener, "/write", "db=mydb"), "", bytes.NewBuffer([]byte(emptyMsg)))
	require.NoError(t, err)
	resp.Body.Close()
	require.EqualValues(t, 204, resp.StatusCode)
}

func TestQueryAndPingHTTPS(t *testing.T) {
	listener := newTestHTTPSListener()
