...
[[inputs.statsd]]
  ...
  ## Restrict which fields are calculated for timing & histogram stats.
  ## Valid values are "count", "mean", "median", "stddev", "sum", "upper"
  ## and "lower". Defaults to all fields when unset.
  # calculated_timer_metrics = ["count", "mean", "median", "stddev", "sum", "upper", "lower"]
