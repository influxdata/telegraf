...
func (c *clientV6) getFieldMapping(ctx context.Context, index, field string) (map[string]any, error) {
...
func (c *clientV6) query(ctx context.Context, aggregation *aggregation) (any, int64, error) {
