...
func TestRedisSentinels(t *testing.T) {
	...
	expectedFields := map[string]interface{}{
		...
		"link-refcount":           1,
		"last-ping-sent":          0,
		"last-ok-ping-reply":      516,
		"last-ping-reply":         516,
		"down-after-milliseconds": 30000,
		"last-hello-message":      1905,
		"voted-leader":            "?",
...
func TestRedisSentinelReplicas(t *testing.T) {
	...
	expectedFields := map[string]interface{}{
		...
		"port":                    6380,
		"role-reported":           "slave",
		"role-reported-time":      10267432,
		"runid":                   "70e07dad9e450e2d35f1b75338e0a5341b59d710",
		"slave-priority":          100,
		"slave-repl-offset":       1392400,
	}
