...
type SubscriptionRequest struct {
	...
	PathList []*Path `protobuf:"bytes,2,rep,name=path_list" json:"path_list,omitempty"`
	...
	AdditionalConfig *SubscriptionAdditionalConfig `protobuf:"bytes,3,opt,name=additional_config" json:"additional_config,omitempty"`
}
...
type SubscriptionInput struct {
	...
	CollectorList []*Collector `protobuf:"bytes,1,rep,name=collector_list" json:"collector_list,omitempty"`
}
...
type Path struct {
	...
	SuppressUnchanged bool `protobuf:"varint,3,opt,name=suppress_unchanged" json:"suppress_unchanged,omitempty"`
	...
	MaxSilentInterval uint32 `protobuf:"varint,4,opt,name=max_silent_interval" json:"max_silent_interval,omitempty"`
...
type SubscriptionAdditionalConfig struct {
	...
	LimitRecords int32 `protobuf:"varint,1,opt,name=limit_records" json:"limit_records,omitempty"`
	// limit the time the stream remains open
	LimitTimeSeconds int32 `protobuf:"varint,2,opt,name=limit_time_seconds" json:"limit_time_seconds,omitempty"`
}
...
type SubscriptionResponse struct {
	...
	SubscriptionId uint32 `protobuf:"varint,1,opt,name=subscription_id" json:"subscription_id,omitempty"`
}
...
type OpenConfigData struct {
	...
	SystemId string `protobuf:"bytes,1,opt,name=system_id" json:"system_id,omitempty"`
...
type KeyValue_DoubleValue struct {
	DoubleValue float64 `protobuf:"fixed64,5,opt,name=double_value,oneof"`
}
type KeyValue_IntValue struct {
	IntValue int64 `protobuf:"varint,6,opt,name=int_value,oneof"`
}
type KeyValue_UintValue struct {
	UintValue uint64 `protobuf:"varint,7,opt,name=uint_value,oneof"`
}
type KeyValue_SintValue struct {
	SintValue int64 `protobuf:"zigzag64,8,opt,name=sint_value,oneof"`
}
type KeyValue_BoolValue struct {
	BoolValue bool `protobuf:"varint,9,opt,name=bool_value,oneof"`
}
type KeyValue_StrValue struct {
	StrValue string `protobuf:"bytes,10,opt,name=str_value,oneof"`
}
type KeyValue_BytesValue struct {
	BytesValue []byte `protobuf:"bytes,11,opt,name=bytes_value,proto3,oneof"`
}
...
type CancelSubscriptionReply struct {
	...
	// Return code string
	CodeStr string `protobuf:"bytes,2,opt,name=code_str" json:"code_str,omitempty"`
}
...
type GetSubscriptionsReply struct {
	...
	SubscriptionList []*SubscriptionReply `protobuf:"bytes,1,rep,name=subscription_list" json:"subscription_list,omitempty"`
}
...
type DataEncodingReply struct {
	EncodingList []EncodingType `protobuf:"varint,1,rep,name=encoding_list,enum=telemetry.EncodingType" json:"encoding_list,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
