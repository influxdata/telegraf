...
func (*gosmiTranslator) SnmpFormatEnum(oid string, value any, full bool) (string, error) {
	if value == nil {
		return "", nil
	}
...
func (*gosmiTranslator) SnmpFormatDisplayHint(oid string, value any) (string, error) {
	if value == nil {
		return "", nil
	}
