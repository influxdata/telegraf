...
func TestSerializeMultiFields(t *testing.T) {
	...
	expS := []byte(fmt.Sprintf(`[{"metric_type":"usage_idle","resource":"","node":"","value":90,"timestamp":%d,"ci2metric_id":{"node":""},"source":"Telegraf"},{"metric_type":"usage_total","resource":"","node":"","value":8559615,"timestamp":%d,"ci2metric_id":{"node":""},"source":"Telegraf"}]`, now.Unix()*1000, now.Unix()*1000))
	assert.Equal(t, string(expS), string(buf))
}
...
func TestSerializeBatch(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, []byte(`[{"metric_type":"value","resource":"","node":"","value":42,"timestamp":0,"ci2metric_id":{"node":""},"source":"Telegraf"}][{"metric_type":"value","resource":"","node":"","value":42,"timestamp":0,"ci2metric_id":{"node":""},"source":"Telegraf"}]`), buf)
}
