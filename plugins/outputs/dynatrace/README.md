...
This plugin requires Dynatrace version 1.202 or higher. You will either need a Dynatrace OneAgent installed on the same host or vm as Telegraf with version 1.201 or higher; or a Dynatrace environment with version 1.202 or higher  
