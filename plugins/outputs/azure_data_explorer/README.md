...
[[outputs.azure_data_explorer]]
  ...
  ##  Ingestion is supported through managed(streaming with fallback to batched ingestion or queued ) or queued, allowed values can be "managed" or "queued", with default to "queued"
  # ingestion_type : "" 
```
