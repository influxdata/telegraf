...
func (c *httpClient) splitAndWriteBatch(ctx context.Context, bucket string, metrics []telegraf.Metric) error {
	c.log.Warnf("W! [outputs.influxdb_v2] Retrying write after splitting metric payload in half to reduce batch size")
...
func (c *httpClient) writeBatch(ctx context.Context, bucket string, metrics []telegraf.Metric) error {
	...
	case http.StatusRequestEntityTooLarge:
		c.log.Errorf("E! [outputs.influxdb_v2] Failed to write metric, request was too large (413)")
		return &APIError{
