...
[[outputs.opentelemetry]]
  ...
  ## Set use_system_proxy to honor the HTTP_PROXY/HTTPS_PROXY/NO_PROXY environment
  ## variables, or set http_proxy_url to a fixed HTTP CONNECT proxy.
  # use_system_proxy = false
  # http_proxy_url = ""

  ## Optional proxy settings for gRPC endpoints (service_address is host:port)
  ## The proxy uses SOCKS5 semantics (golang.org/x/net/proxy), not HTTP CONNECT.
  ## Set use_proxy and provide a socks5:// proxy_url, or leave proxy_url empty to
  ## use the ALL_PROXY/all_proxy environment variable.
  # use_proxy = false
  # proxy_url = ""
