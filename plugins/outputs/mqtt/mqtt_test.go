...
func TestIntegrationConnectAndWrite(t *testing.T) {
	if testing.Short() {
	...
	t.Run("MQTTv3 publish and subscribe", func(t *testing.T) {
	...
	t.Run("MQTTv5 properties", func(t *testing.T) {
		tests := []struct {
			name       string
...
func TestIntegrationMQTTLayout(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	...
	t.Run("homie-v4", func(t *testing.T) {
		// Setup the plugin
		topic := "homie"
		plugin := &MQTT{
			MqttConfig: mqtt.MqttConfig{
