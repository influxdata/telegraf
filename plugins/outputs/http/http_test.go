	...
	tests := []struct {
		...
		},
		{
			...
			tokenHandler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				...
				fmt.Println("Hello token handler")
				fmt.Printf("%+v\n", r)
