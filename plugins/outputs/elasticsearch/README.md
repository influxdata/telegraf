...
[[outputs.elasticsearch]]
  ...
  ## 1. Single values (comma-separated strings will be split - DEPRECATED):
  ##    "Header-Name" = "value1,value2,value3"  # Creates 3 separate headers
  ## 2. Array values (recommended for multiple values):
  ##    "Header-Name" = ["value1", "value2", "value3"]
  ##
  ## Examples:
  # [outputs.elasticsearch.headers]
  #   # Single values - comma-separated strings get split (deprecated behavior)
  #   "X-Custom-Header1" = "custom-value1"
  #   "X-Custom-Header2" = "custom-value2,will,be,split"  # Creates 4 headers with deprecation warning
  #
  #   # Multiple values - recommended approach using arrays
  #   "X-Custom-Header4" = ["custom-value4a", "custom-value4b"]
  #   "X-Custom-Header5" = ["custom-value5a", "custom-value5b", "custom-value5c"]
