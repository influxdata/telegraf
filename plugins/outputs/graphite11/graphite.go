...
func (g *Graphite11) Connect() error {
	// Set default values
	if g.Timeout <= 0 {
		g.Timeout = 2
	}
...
func (g *Graphite11) SampleConfig() string {
	return sampleConfig
}

func (g *Graphite11) Description() string {
...
func (g *Graphite11) Write(metrics []telegraf.Metric) error {
	// Prepare data
	var batch []byte
	s, err := serializers.NewGraphite11Serializer(g.Prefix, g.Template)
	if err != nil {
		return err
	}
...
func (g *Graphite11) send(batch []byte) error {
...
func init() {
	outputs.Add("graphite11", func() telegraf.Output {
		return &Graphite11{}
	})
}
