	...
	tests := []struct {
		...
		},
		{
			...
			expected: []telegraf.Metric{
				testutil.MustMetric("cpu",
					map[string]string{},
					map[string]interface{}{"value": uint64(37)},
					time.Unix(0, 0),
				),
				testutil.MustMetric("cpu",
					map[string]string{},
		...
		},
		{
			...
			expected: []telegraf.Metric{
				testutil.MustMetric("cpu",
					map[string]string{},
					map[string]interface{}{"value": float64(0.003)},
					time.Unix(0, 0),
				),
				testutil.MustMetric("cpu",
					map[string]string{},
					map[string]interface{}{"value": float64(6003)},
					time.Unix(0, 0),
				),
			},
		...
		},
		{
			...
			expected: []telegraf.Metric{
				testutil.MustMetric("cpu",
					map[string]string{},
					map[string]interface{}{"value": float64(0.00025)},
					time.Unix(0, 0),
				),
				testutil.MustMetric("cpu",
					map[string]string{},
					map[string]interface{}{"value": float64(500.25)},
					time.Unix(0, 0),
				),
			},
			distribution: &testDistribution{value: -0.5},
