	...
	testcases := []testcase{
		{
			...
			expected: []telegraf.Metric{
				...
				metric.New("bar", map[string]string{}, map[string]any{"value": 99}, time.Unix(0, 0)),
				metric.New("baz", map[string]string{}, map[string]any{"value": 1}, time.Unix(0, 0)),
				metric.New("new", map[string]string{}, map[string]any{"value": 42}, time.Unix(0, 0)),
				metric.New("new", map[string]string{}, map[string]any{"value": 99}, time.Unix(0, 0)),
				metric.New("new", map[string]string{}, map[string]any{"value": 1}, time.Unix(0, 0)),
			},
		},
		{
			name:         "drop original",
