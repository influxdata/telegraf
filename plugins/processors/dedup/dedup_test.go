		...
		},
		{
			...
			input: []telegraf.Metric{
				metric.New("metric",
					...
					map[string]any{"foo": 1}, // field
					now,
				),
				metric.New(
					"metric",
					map[string]string{"tag": "value"},
					map[string]any{"bar": 1}, // different field
					now,
				),
				metric.New(
					"metric",
					map[string]string{"tag": "value"},
					map[string]any{"bar": 2}, // same field different value
					now,
				),
				metric.New(
					"metric",
					map[string]string{"tag": "value"},
					map[string]any{"bar": 2}, // same field same value
					now,
				),
			},
			expected: []telegraf.Metric{
