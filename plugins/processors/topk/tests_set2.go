...
func setupTestSet2() {
	ans23GroupBy1.AddField("value_sumag", float64(74.18))
	ans24GroupBy1.AddField("value_sumag", float64(72))
	ans25GroupBy1.AddField("value_sumag", float64(163.22))
	ans26GroupBy1.AddField("value_sumag", float64(163.22))

	ans22GroupBy2.AddField("value_mean", float64(74.20750000000001))
	ans23GroupBy2.AddField("value_mean", float64(74.20750000000001))
	ans25GroupBy2.AddField("value_mean", float64(74.20750000000001))
	ans26GroupBy2.AddField("value_mean", float64(74.20750000000001))

	ans25GroupBy3.AddField("value_minaggfield", float64(75.3))
	ans26GroupBy3.AddField("value_minaggfield", float64(75.3))

	ans21GroupBy4.AddField("A_mean", float64(95.36))
	ans22GroupBy4.AddField("A_mean", float64(39.01))
	ans23GroupBy4.AddField("A_mean", float64(39.01))

	ans21GroupBy5.AddField("C_sum", float64(72.41))
	ans23GroupBy5.AddField("B_sum", float64(60.96))
	ans25GroupBy5.AddField("B_sum", float64(81.55))
	ans25GroupBy5.AddField("C_sum", float64(49.96))
	ans26GroupBy5.AddField("C_sum", float64(49.96))

	ans24GroupByMetric1.AddField("value_sigma", float64(235.22000000000003))
	ans25GroupByMetric1.AddField("value_sigma", float64(235.22000000000003))
	ans26GroupByMetric1.AddField("value_sigma", float64(235.22000000000003))

	ans21GroupByMetric2.AddField("A_SUM", float64(95.36))
	ans22GroupByMetric2.AddField("A_SUM", float64(78.02))
	ans22GroupByMetric2.AddField("value_SUM", float64(133.61))
	ans23GroupByMetric2.AddField("A_SUM", float64(78.02))
	ans23GroupByMetric2.AddField("value_SUM", float64(133.61))
	ans25GroupByMetric2.AddField("value_SUM", float64(87.92))

	ans23DontDropBot.AddField("value_sumag", float64(74.18))
	ans23DontDropBot.AddField("value_aggpos", 2)
	ans24DontDropBot.AddField("value_sumag", float64(72))
	ans24DontDropBot.AddField("value_aggpos", 3)
	ans25DontDropBot.AddField("value_sumag", float64(163.22))
	ans25DontDropBot.AddField("value_aggpos", 1)
	ans26DontDropBot.AddField("value_sumag", float64(163.22))
	ans26DontDropBot.AddField("value_aggpos", 1)

	ans23GroupByKeyTag.AddTag("gbt", "metric1&tag1=TWO&tag3=SIX&")
	ans24GroupByKeyTag.AddTag("gbt", "metric2&tag1=ONE&tag3=THREE&")
	ans25GroupByKeyTag.AddTag("gbt", "metric2&tag1=TWO&tag3=SEVEN&")
	ans26GroupByKeyTag.AddTag("gbt", "metric2&tag1=TWO&tag3=SEVEN&")

	ans23NoDrops1.AddField("value_aggregate", float64(74.18))
	ans23NoDrops1.AddField("value_rank", 2)
	ans24NoDrops1.AddField("value_aggregate", float64(72))
	ans24NoDrops1.AddField("value_rank", 3)
	ans25NoDrops1.AddField("value_aggregate", float64(163.22))
	ans25NoDrops1.AddField("value_rank", 1)
	ans26NoDrops1.AddField("value_aggregate", float64(163.22))
	ans26NoDrops1.AddField("value_rank", 1)
