	...
	expectedV1 := []telegraf.Metric{
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"counter_reset_hint":     testHistogram.CounterResetHint,
				"positive_span_0_offset": testHistogram.PositiveSpans[0].Offset,
				"positive_span_0_length": testHistogram.PositiveSpans[0].Length,
				"positive_span_1_offset": testHistogram.PositiveSpans[1].Offset,
				"positive_span_1_length": testHistogram.PositiveSpans[1].Length,
				...
				"positive_bucket_2":      float64(testHistogram.PositiveBuckets[2] + testHistogram.PositiveBuckets[1] + testHistogram.PositiveBuckets[0]),
				"positive_bucket_3":      float64(testHistogram.PositiveBuckets[3] + testHistogram.PositiveBuckets[2] + testHistogram.PositiveBuckets[1] + testHistogram.PositiveBuckets[0]),
				"negative_span_0_offset": testHistogram.NegativeSpans[0].Offset,
				"negative_span_0_length": testHistogram.NegativeSpans[0].Length,
				"negative_span_1_offset": testHistogram.NegativeSpans[1].Offset,
				"negative_span_1_length": testHistogram.NegativeSpans[1].Length,
				...
				"negative_bucket_2":      float64(testHistogram.NegativeBuckets[2] + testHistogram.NegativeBuckets[1] + testHistogram.NegativeBuckets[0]),
				"negative_bucket_3":      float64(testHistogram.NegativeBuckets[3] + testHistogram.NegativeBuckets[2] + testHistogram.NegativeBuckets[1] + testHistogram.NegativeBuckets[0]),
		...
		testutil.MustMetric(
			...
			map[string]interface{}{
				...
				"counter_reset_hint":     testFloatHistogram.CounterResetHint,
				"positive_span_0_offset": testFloatHistogram.PositiveSpans[0].Offset,
				"positive_span_0_length": testFloatHistogram.PositiveSpans[0].Length,
				"positive_span_1_offset": testFloatHistogram.PositiveSpans[1].Offset,
				"positive_span_1_length": testFloatHistogram.PositiveSpans[1].Length,
				...
				"negative_span_0_offset": testFloatHistogram.NegativeSpans[0].Offset,
				"negative_span_0_length": testFloatHistogram.NegativeSpans[0].Length,
				"negative_span_1_offset": testFloatHistogram.NegativeSpans[1].Offset,
				"negative_span_1_length": testFloatHistogram.NegativeSpans[1].Length,
