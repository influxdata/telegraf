...
func (h *Parser) Parse(packet []byte) ([]telegraf.Metric, error) {
	...
	jsonParser := json.JSONParser{MetricName: h.MetricName,
		TagKeys:        h.TagKeys,
		StringFields:   h.StringFields,
		JSONNameKey:    h.JSONNameKey,
		JSONQuery:      h.JSONQuery,
		JSONTimeKey:    h.JSONTimeKey,
		JSONTimeFormat: h.JSONTimeFormat,
		JSONTimezone:   h.JSONTimezone,
