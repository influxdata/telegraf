...
func BenchmarkRunningOutputAddWrite(b *testing.B) {
	...
	m := &perfOutput{}
	ro := NewRunningOutput("test", m, conf, 1000, 10000, "123")
...
func TestRunningOutputWriteFail(t *testing.T) {
	...
	m := &mockOutput{}
	m.failWrite = true
	ro := NewRunningOutput("test", m, conf, 4, 12, "123")
...
func TestRunningOutputWriteFailOrder(t *testing.T) {
	...
	m := &mockOutput{}
	m.failWrite = true
	ro := NewRunningOutput("test", m, conf, 100, 1000, "123")
...
func TestRunningOutputWriteFailOrder2(t *testing.T) {
	...
	m := &mockOutput{}
	m.failWrite = true
	ro := NewRunningOutput("test", m, conf, 5, 100, "123")
...
func TestRunningOutputWriteFailOrder3(t *testing.T) {
	...
	m := &mockOutput{}
	m.failWrite = true
	ro := NewRunningOutput("test", m, conf, 5, 1000, "123")
