...
require (
	...
	github.com/DamRCorba/huawei_telemetry_sensors v0.0.0-20200303204802-9d9cdfdbfa02
	github.com/DamRCorba/telegraf v0.10.1 // indirect
	...
	github.com/influxdata/influxdb v1.9.0 // indirect
