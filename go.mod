...
require (
	...
	github.com/leodido/go-syslog/v4 v4.2.1-0.20250421191238-de2e76af1251
...
replace collectd.org => github.com/mstrandboge/go-collectd v0.0.0-20250807161835-85f0ec02fe52
